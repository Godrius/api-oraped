...
import br.com.oraped.service.produto.MarcaProdutoService;
...
public class AdminMarcaService {
    ...
    public AdministradorWhatsappResultados.ResultadoAdmin iniciarCadastroMarcaPorDigitacao(
        ...
        sessaoAdminMarcaService.marcarAguardandoNovaMarca(idSessao, safeOffset);
    ...
    public AdministradorWhatsappResultados.ResultadoAdminMarca concluirCadastroMarcaPorDigitacao(
        ...
        int safeOffset = sessaoAdminMarcaService.getOffsetNovaMarca(idSessao);

        MarcaProduto m = marcaProdutoService.criar(estabelecimento.getId(), nomeMarca.trim());
        sessaoAdminMarcaService.limparAguardandoNovaMarca(idSessao);
    ...
    public AdministradorWhatsappResultados.ResultadoAdmin iniciarAlteracaoNomeMarcaPorDigitacao(
        ...
        sessaoAdminMarcaService.marcarAguardandoEditarMarcaNome(idSessao, idMarca, safeOffset);
    ...
    public AdministradorWhatsappResultados.ResultadoAdminMarca concluirAlteracaoNomeMarcaPorDigitacao(
        ...
        Long idMarca = sessaoAdminMarcaService.getIdMarcaEditarNome(idSessao);
        int safeOffset = sessaoAdminMarcaService.getOffsetEditarMarcaNome(idSessao);
        ...
        sessaoAdminMarcaService.limparAguardandoEditarMarcaNome(idSessao);
